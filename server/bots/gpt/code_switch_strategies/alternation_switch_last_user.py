...
class AlternationSwitchLastUser(CodeSwitchStrategy):
    """
    Translates on the Turn level - i.e.: can translate more than one utterance (translate to the opposite of the user lng)
    """
