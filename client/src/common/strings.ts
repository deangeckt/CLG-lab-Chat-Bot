...
//     "If there is a route already drawn on your map, you’ll be GIVING directions to your partner. If there is a map with no route traced on it, you'll need to ASK QUESTIONS to figure out which route to take (a path from ✕ to ✓).",
...
export const ins_instructions_str = [
    ...
    "The better your path matches the shape of the goal path, the bigger the bonus payment you will receive. También es posible recibir un bonus por ser un compañero colaborador in the game. Don't hesitate to ask questions as needed y da suficientes detalles para que las rutas sean as close as possible.",
    'Thanks! Mucha suerte!  🙂',
];
