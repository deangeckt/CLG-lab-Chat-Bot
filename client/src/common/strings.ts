...
export const ins_sub_title_str =
    'Thanks for your participation! You’ll be working with a partner to give directions on a map, all using written text.';
export const ins_instructions_str = [
    'You and your partner have been given the same map, the only difference is that you have a route traced on the map (a path from ✕ to ✓), and the other will have the map without a route.',
    'You’ll be giving directions to your partner. Your partner will trace the route according to what you tell them. You can communicate with your partner as much as you would like using the chat.',
    "Don't hesitate to ask questions!",
    'Thanks and best of luck! 🙂',
];
